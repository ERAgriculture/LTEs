...
require(ERAg) #If it is your first time downloading the ERA package follow the "Download_ERAg_Package" code.
require(tidyr)
require(treemap)
require(s3fs)
require(miceadds)
...
Link to training materials: https://cgiar-my.sharepoint.com/:x:/r/personal/p_steward_cgiar_org/Documents/ERA/Data%20Entry/Data%20Entry%202023/Training%Material


### Link to extracted excels
2018 https://cgiar-my.sharepoint.com/:x:/r/personal/p_steward_cgiar_org/Documents/ERA/Data%20Entry/Data%20Entry%2018
2020 https://cgiar-my.sharepoint.com/:x:/r/personal/p_steward_cgiar_org/Documents/ERA/Data%20Entry/Data%20Entry%2020
2022 https://cgiar-my.sharepoint.com/:x:/r/personal/p_steward_cgiar_org/Documents/ERA/Data%20Entry/Data%20Entry%2022/Data
2023 https://cgiar-my.sharepoint.com/:x:/r/personal/p_steward_cgiar_org/Documents/ERA/Data%20Entry/Data%20Entry%2023/Data
...
#you can also download the data tables from the data folder directly 
#Tables<-load.Rdata2("industrious_elephant_2023-2024-11-14.RData")
...
# Load unique LTEs if available
# unique_ltes <- read_delim("C:/Users/mlolita/OneDrive - CGIAR/ERA/LTEs 2024/data/unique.ltes.csv", 
#     delim = ";", escape_double = FALSE, trim_ws = TRUE)

unique_ltes<-readRDS("unique.ltes.rds")
...
```{r,warning=FALSE,fig.width=6, fig.height=4,fig.align='center',message=FALSE}
...
```{r,warning=FALSE,fig.width=8, fig.height=6,fig.align='center',message=FALSE}
...
#era_master_sheet_out_ <- read_csv("C:/Users/mlolita/OneDrive - CGIAR/ERA/ERA/Concept Scheme/Outcomes.csv")

era_master_sheet_out_ <- read_csv("Outcomes.csv")
